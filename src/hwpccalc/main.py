...
def run(args):
    ...
    me.run_simulation()
    print(names.Names.Output.scenario_info)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-p", "--path", help="Path to uploaded user data to run on", default="hwpc-user-inputs/c97c02f6-596f-449f-8b0a-ebb4c3e4a396")
