...
#             "Total cumulative metric tons carbon stored in recovered products in use manufactured from total timber harvested from "
#             + str(total_all_dispositions[nm.Fields.harvest_year].min())
#             + " to "
#             + str(total_all_dispositions[nm.Fields.harvest_year].max())
#             + ". Carbon in recovered products in use are recycled wood and paper that reenters the products in use category. Carbon emissions are displayed in units of carbon dioxide equivalent (CO2e) and do not include other carbon-based greenhouse gases such as methane.",
...
#             0.3,
#             "Total Cumulative Carbon in Recovered Products in Use",
#             "Total cumulative megagrams carbon stored in recovered products in use manufactured from total timber harvested from "
#             + str(total_all_dispositions[nm.Fields.harvest_year].min())
#             + " to "
#             + str(total_all_dispositions[nm.Fields.harvest_year].max())
#             + ". Carbon in recovered products in use are recycled wood and paper that reenters the products in use category.",
...
#             "Total cumulative metric tons carbon emitted from recovered products manufactured from total timber harvested from "
#             + str(total_all_dispositions[nm.Fields.harvest_year].min())
#             + " to "
#             + str(total_all_dispositions[nm.Fields.harvest_year].max())
#             + ". Carbon emitted from recovered products in use is recycled wood and paper that reenters the products in use category. Carbon emissions are displayed in units of carbon dioxide equivalent (CO2e) and do not include other carbon-based greenhouse gases such as methane.",
...
#             "Total cumulative metric ton carbon emitted from burning discarded products with energy capture manufactured from total timber harvested from "
#             + str(burned_w_energy_capture_emit.index.min())
#             + " to "
#             + str(burned_w_energy_capture_emit.index.max())
#             + ". Discarded products are assumed to be burned in an incinerator with energy capture. Emmitted carbon is displayed in units of carbon dioxide equivalent (CO2e) and do not include other carbon-based greenhouse gases such as methane.",
...
#             "hwpcarbon-data",
#             self.zip_buffer,
#             nm.Output.output_path + "/results/" + nm.Output.run_name + ".zip",
#             "application/zip",
#         )
...
#         df = df.merge(
#             self.md.data[nm.Tables.primary_products],
#             how="outer",
#             on=[nm.Fields.timber_product_id, nm.Fields.primary_product_id],
#         )
...
#             plt.ticklabel_format(axis="y", style="sci", scilimits=(1, 5))
#             txt = (
#                 "Total cumulative metric tons of carbon stocks in harvested wood products (HWP) manufactured from total timber harvested from "
#                 + str(big_table[nm.Fields.harvest_year].min())
#                 + " to "
...
#                 big_table[nm.Fields.co2(P(nm.Fields.swds))].values,
#                 colors=("tab:red", "tab:blue"),
#                 labels=("Products In Use", "SWDS"),
#             )
...
#                 big_table[nm.Fields.mgc(P(nm.Fields.swds))].values,
#                 colors=("tab:red", "tab:blue"),
#                 labels=("Products In Use", "SWDS"),
#             )
...
#                 + " to "
#                 + str(big_table[nm.Fields.harvest_year].max())
#                 + " using the IPCC Tier 3 Production Approach. Carbon in HWP includes both products that are still in use and carbon stored at solid waste disposal sites (SWDS). Carbon emissions are displayed in units of carbon dioxide equivalent (CO2e) and do not include other carbon-based greenhouse gases such as methane."
#             )
...
#                 + " to "
#                 + str(big_table[nm.Fields.harvest_year].max())
#                 + " using the IPCC Tier 3 Production Approach. Carbon in HWP includes both products that are still in use and carbon stored at solid waste disposal sites (SWDS)."
#             )
...
#             txt = (
#                 "Total cumulative metric tons of carbon stocks in harvested wood products (HWP) manufactured from total timber harvested from "
#                 + str(final[nm.Fields.harvest_year].min())
#                 + " to "
...
#             temp.seek(0)
#             self.zip.writestr(
#                 "annual_timber_product_output.csv",
#                 temp.read(),
#                 compress_type=zipfile.ZIP_STORED,
#             )
...
#         plt.xlabel("Inventory Year")
#         txt = (
#             "Annual total timber harvest and product output converted to metric tons of carbon, from "
#             + str(timber_products_results[nm.Fields.harvest_year].min())
#             + " to "
...
#             color=color,
#             label="Timber Product Output (Metric Tons C)",
#         )
#         color = "tab:blue"
#         ax.plot(
#             timber_products_results[nm.Fields.harvest_year],
#             harvests_results[nm.Fields.ccf],
#             color=color,
#             label="Annual Harvest (CCF)",
#         )
...
#                 label="Primary Products Sum",
#             )
#             ax.plot(
#                 big_table[nm.Fields.harvest_year],
#                 big_table[nm.Fields.co2(nm.Fields.products_in_use)],
#                 label="Products in Use",
#             )
#             ax.plot(
#                 big_table[nm.Fields.harvest_year],
#                 big_table[nm.Fields.co2(P(nm.Fields.swds))],
#                 label="SWDS",
#             )
#             ax.plot(
#                 big_table[nm.Fields.harvest_year],
#                 big_table[nm.Fields.co2("all_" + nm.Fields.emitted)],
#                 label="Emitted",
#             )
#             ax.plot(
#                 big_table[nm.Fields.harvest_year],
...
#             ax.plot(
#                 big_table[nm.Fields.harvest_year],
#                 big_table[nm.Fields.mgc(nm.Fields.products_in_use)],
#                 label="Products in Use",
#             )
#             ax.plot(
#                 big_table[nm.Fields.harvest_year],
#                 big_table[nm.Fields.mgc(P(nm.Fields.swds))],
#                 label="SWDS",
#             )
#             ax.plot(
#                 big_table[nm.Fields.harvest_year],
#                 big_table[nm.Fields.mgc("all_" + nm.Fields.emitted)],
#                 label="Emitted",
#             )
#             ax.plot(
#                 big_table[nm.Fields.harvest_year],
