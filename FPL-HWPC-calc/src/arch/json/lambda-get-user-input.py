                    ...
                    "environment": [
                        {
                            ...
                            "value": os.getenv("AWS_CLUSTER_ARN"),
                        },
                        {
                            "name": "AWS_SECURITY_GROUP",
                            "value": os.getenv("AWS_SECURITY_GROUP"),
                        },
                        {"name": "AWS_SUBNET_ID", "value": os.getenv("AWS_SUBNET_ID")},
                        {"name": "AWS_VPC_ID", "value": os.getenv("AWS_VPC_ID")},
                        {
                            "name": "DASK_N_WORKERS",
                            "value": os.getenv("DASK_N_WORKERS"),
                        },
                        {"name": "HWPC__PURE_S3", "value": os.getenv("HWPC__PURE_S3")},
                        {"name": "HWPC__CDN_URI", "value": os.getenv("HWPC__CDN_URI")},
                        {
                            "name": "HWPC__FIRST_RECYCLE_YEAR",
                            "value": os.getenv("HWPC__FIRST_RECYCLE_YEAR"),
                        },
                        {
                            "name": "HWPC__RECURSE_LIMIT",
                            "value": os.getenv("HWPC__RECURSE_LIMIT"),
                        },
                        {
                            "name": "S3_INPUT_BUCKET",
                            "value": os.getenv("S3_INPUT_BUCKET"),
                        },
                        {
                            "name": "S3_OUTPUT_BUCKET",
                            "value": os.getenv("S3_OUTPUT_BUCKET"),
                        },
                    ],
                }
            ]
